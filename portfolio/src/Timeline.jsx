  ...
  <section className="py-20 px-4 md:px-8 lg:px-16">
    ...
    <div className="relative max-w-6xl mx-auto">
      ...
      <div className="flex flex-wrap justify-center gap-8">
        {events.map(({ icon: Icon, title, date, details }, index) => (
          <motion.div
            key={index}
            className={`relative flex items-center p-6 bg-gray-900 hover:cursor-pointer border border-gray-700 rounded-lg shadow-lg transition-all duration-300 w-full sm:max-w-[calc(50%-20px)] lg:max-w-[calc(33.33%-20px)]`}
